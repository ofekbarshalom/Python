...
def open_search_books_window():
    ...
    table.column("Title", width=column_width)

    table.heading("Author", text="Author")
    table.column("Author", width=column_width)

    table.heading("Is Loaned", text="Is Loaned")
    table.column("Is Loaned", width=column_width)

    table.heading("Copies", text="Copies")
    table.column("Copies", width=column_width)

    table.heading("Genre", text="Genre")
    table.column("Genre", width=column_width)

    table.heading("Year", text="Year")
    table.column("Year", width=column_width)
