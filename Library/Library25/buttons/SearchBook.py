...
class SearchByTitle(SearchStrategy):
    """
        Search strategy for filtering books by title.
    """
...
class SearchByAuthor(SearchStrategy):
    """
        Search strategy for filtering books by author.
    """
    def search(self, query, books_df):
...
class SearchByGenre(SearchStrategy):
    """
        Search strategy for filtering books by genre.
    """
    def search(self, query, books_df):
...
def perform_search(search_entry, search_type_combobox, table):
    """
        Perform the search based on the selected criteria and refresh the table.
    """
...
def open_search_books_window():
    """
        Open the Search Books window with functionality for searching and displaying results.
    """
