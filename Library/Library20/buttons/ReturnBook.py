...
def add_message_to_users(books_waiting_list_first_name, book_title):
...
def update_files(book_title):
    ...
    # Print remaining copies and increment copies_available in files
    ...
    if books_waiting_list_first_name:
        add_message_to_users(books_waiting_list_first_name, book_title)
