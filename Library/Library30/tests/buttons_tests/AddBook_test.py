...
class TestAddBook(unittest.TestCase):
    # ----------------------------------------
    # Test for check_copies_and_year
    # ----------------------------------------
    ...
    # ----------------------------------------
    # Test for validate_required_fields
    # ----------------------------------------
    ...
    # ----------------------------------------
    # Test for submit_new_book
    # ----------------------------------------
    @patch('buttons.AddBook.Logger.get_logger')
    ...
    def test_submit_new_book_success(self, mock_add_message_to_users, mock_add_book_to_library, mock_create_book,
                                     mock_check_copies_and_year, mock_check_book_title, mock_get_logger):
        # Mock the logger
        mock_logger = MagicMock()
        mock_get_logger.return_value = mock_logger

        # Mock return values for other dependencies
        ...
        mock_logger.info.assert_called_with("Book added successfully")
